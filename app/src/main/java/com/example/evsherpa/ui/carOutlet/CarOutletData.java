...
public class CarOutletData {
    ...
    public CarOutletData(int outlet_profile, String txt_connector_name, String txt_charge_current, String txt_charge_power, String txt_charge_level, String txt_available_car) {
